...
// unported legacy concept with no equivalent in this migration — day close has since been
// removed entirely), and the `forwardRef`/`sendAutoMessage` imperative handle (nothing in this
